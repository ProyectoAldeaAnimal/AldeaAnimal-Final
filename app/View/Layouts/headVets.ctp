            ...
            <div class="container m1 menu">
              <div class= "collapse navbar-collapse navbar-ex1-collapse">
                  <ul  class ="nav navbar-nav subMenu" >
                      ...
                      <li><a class= "page-scroll"href="/AldeaAnimal/vets/homeVet"><FONT COLOR="#FFFFFF">  Registrar Mascota</FONT></a></li>
                      <li><a class= "page-scroll"href="/AldeaAnimal/vets/homeVet"><FONT COLOR="#FFFFFF">  Administración</FONT></a></li>                                             
